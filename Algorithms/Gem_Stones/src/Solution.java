...
public class Solution {
    ...
    public static String[] inputPhase(String STDIN){
        ...
        System.out.print("Enter number of rocks: "); //comment out to pass default test case
        STDIN = in.nextLine();
        ...
        for(int i=0; i<=numRocks-1; i++) {
            System.out.print("Enter combination for rock " + (i+1) + ": "); //comment out to pass default test case
            STDIN = in.nextLine();
